...
You are the **dashboard-ui** worker in this czarina orchestration.

## Your Role
Build comprehensive web dashboard for LLM usage statistics, audit log viewer, and real-time monitori

## Your Instructions
Full task list: $(pwd)/../workers/dashboard-ui.md

Read it now:
```bash
cat ../workers/dashboard-ui.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/dashboard-ui.md
```

## Quick Reference
- **Branch:** cz1/feat/dashboard-ui
- **Location:** /home/jhenry/Source/yori/.czarina/worktrees/dashboard-ui
...
## Your Mission
1. Read your full instructions at ../workers/dashboard-ui.md
