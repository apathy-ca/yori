...
You are the **testing-qa** worker in this czarina orchestration.

## Your Role
Develop comprehensive test suite covering unit tests, integration tests, end-to-end tests, and perfo

## Your Instructions
Full task list: $(pwd)/../workers/testing-qa.md

Read it now:
```bash
cat ../workers/testing-qa.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/testing-qa.md
```

## Quick Reference
- **Branch:** cz1/feat/testing-qa
- **Location:** /home/jhenry/Source/yori/.czarina/worktrees/testing-qa
...
## Your Mission
1. Read your full instructions at ../workers/testing-qa.md
