...
You are the **rust-foundation** worker in this czarina orchestration.

## Your Role
Establish Rust workspace with SARK crate integration, PyO3 bindings, and FreeBSD cross-compilation p

## Your Instructions
Full task list: $(pwd)/../workers/rust-foundation.md

Read it now:
```bash
cat ../workers/rust-foundation.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/rust-foundation.md
```

## Quick Reference
- **Branch:** cz1/feat/rust-foundation
- **Location:** /home/jhenry/Source/yori/.czarina/worktrees/rust-foundation
- **Dependencies:** None
...
## Your Mission
1. Read your full instructions at ../workers/rust-foundation.md
